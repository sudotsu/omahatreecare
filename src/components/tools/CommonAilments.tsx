...
type AilmentType = 'pest' | 'disease' | 'environmental'
...
const ailments: Ailment[] = [
  ...
  },
  {
    ...
    timing: 'Disease most active in warm, wet spring weather. Prune infected branches on appearance',
  },
  {
    name: 'Apple Scab',
    type: 'disease',
...
function getTypeColor(type: AilmentType) {
  switch (type) {
...
function getTypeIcon(type: AilmentType) {
  switch (type) {
...
function getSeverityGradient(severity: Severity) {
  switch (severity) {
    ...
    case 'serious':  return 'from-orange-600 to-orange-800'
    case 'moderate': return 'from-yellow-600 to-yellow-800'
  }
}

export function CommonAilments({ searchParams }: { searchParams?: Record<string, any> }) {
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
              filterType === 'pest'
                ...
                : 'bg-white text-purple-800 border-2 border-purple-200 hover:border-purple-400'
            }`}
          >
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
              filterType === 'disease'
                ...
                : 'bg-white text-red-800 border-2 border-red-200 hover:border-red-400'
            }`}
          >
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className={`bg-gradient-to-r ${getSeverityGradient(selectedAilment.severity)} text-white p-6`}>
            <div className="flex items-start justify-between mb-3">
              ...
              <button
                ...
                aria-label="Back to ailments list"
              >
          ...
          <div className="p-6 space-y-6">
            <div className="bg-gray-50 rounded-xl p-4">
              <h3 className="font-bold text-amber-900 mb-2">Affected Species:</h3>
              <p className="text-amber-800">{selectedAilment.affectedSpecies.join(', ')}</p>
            </div>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-5">
              <h3 className="text-xl font-bold text-blue-900 mb-3">Prevention</h3>
              <p className="text-blue-900 leading-relaxed">{selectedAilment.prevention}</p>
            </div>

            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-5">
              <h3 className="text-xl font-bold text-amber-900 mb-3">Timing is Critical</h3>
              <p className="text-amber-900 leading-relaxed">{selectedAilment.timing}</p>
            </div>
            ...
            {selectedAilment.severity === 'critical' || selectedAilment.severity === 'serious' ? (
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-5">
                ...
                <div className="space-y-2">
                  ...
                  <a
                    href={`tel:${CONTACT.phoneRaw}`}
                    className="block w-full px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors text-center text-sm"
                  >
                    {CONTACT.phone}
                  </a>
                </div>
