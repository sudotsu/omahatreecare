...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    // Legacy /blog is withheld from search (noindex) pending content review
    // and migration to the Treehouse evidence gate (DOC-001), so it and its
    // posts are intentionally excluded from the sitemap.
