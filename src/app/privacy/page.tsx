...
export const metadata: Metadata = {
  title: "Privacy & Lead Records",
  description: "How Midwest Roots handles website estimate requests and emailed photos.",
  alternates: { canonical: `${CONTACT.siteUrl}/privacy` },
  openGraph: {
    title: "Privacy & Lead Records | Midwest Roots",
    description: "How Midwest Roots handles website estimate requests and emailed photos.",
    url: `${CONTACT.siteUrl}/privacy`,
  },
};

export default function PrivacyPage() {
  return <div className="min-h-screen bg-[#f8f6f1]">
    <section className="bg-[#11261B] px-6 py-16 text-white">
      <div className="mx-auto max-w-4xl text-center">
        <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-amber-400">Website Data Practices</p>
        <h1 className="text-4xl font-bold md:text-5xl">Privacy & Lead Records</h1>
      </div>
    </section>
    <main className="mx-auto max-w-3xl px-6 py-16 text-stone-700">
