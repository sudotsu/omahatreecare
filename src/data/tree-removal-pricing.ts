...
export const TREE_REMOVAL_HEIGHT_RANGES = [
  {
    id: "small",
    articleLabel: "Small — under 25 ft (ornamentals, small evergreens)",
    toolLabel: "Small (~under 25 ft)",
    min: 350,
    max: 780,
  ...
  {
    id: "medium",
    articleLabel: "Medium — about 25–45 ft",
    toolLabel: "Medium (~25–45 ft)",
    min: 820,
    max: 1_330,
    driver: "Moderate canopy, some rigging and lowering",
  },
  {
    id: "large",
    articleLabel: "Large — about 45–65 ft",
    toolLabel: "Large (~45–65 ft)",
    min: 1_040,
    max: 1_740,
    driver: "Heavier limbs, more rigging, larger crew",
  },
  {
    id: "very-large",
    articleLabel: "Very large — about 65 ft and up",
    toolLabel: "Very large (~65 ft+)",
    min: 1_260,
    max: 2_160,
    driver: "Sectional removal near targets, specialized equipment",
  },
] as const;
