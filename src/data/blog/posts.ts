...
export const posts: BlogPost[] = [
  {
    slug: 'omaha-ash-tree-crisis-eab-2025',
    title: "Omaha's Ash Tree Crisis: What Every Homeowner Needs to Know About EAB in 2025",
    excerpt: "Douglas County has had confirmed Emerald Ash Borer presence since 2016. If you have an Ash tree and haven't treated it, read this before it's too late.",
    date: '2025-03-15',
...
3. **Get an assessment.** If the tree is still healthy or shows early symptoms, start a treatment plan immediately. Don't wait until next season.

4. **If removal is necessary, plan it.** Dead Ash wood becomes extremely brittle within 1-2 years. An Ash that's 50% dead today can become dangerous to remove within 18 months as the bark peels and limbs become unpredictable.
...
`,
  ...
  {
    slug: 'why-pin-oak-leaves-are-yellow',
    title: "Why Your Pin Oak Leaves Are Yellow (And It's Not What You Think)",
    excerpt: "Yellow Pin Oak leaves in Omaha aren't a watering problem or a disease — it's almost always Iron Chlorosis, caused by our alkaline clay soil locking out the tree's iron uptake.",
    date: '2025-05-01',
    category: 'Tree Health',
    content: `
...
More effective DIY approaches include:
- **Acidifying fertilizers** (ammonium sulfate) applied repeatedly over years to gradually lower soil pH
- **Elemental sulfur** soil amendments, which soil bacteria convert to sulfuric acid over time
- **Mulching** to the drip line with wood chips, which releases organic acids as they decompose
...
`,
  ...
  {
    slug: 'bradford-pear-problem-omaha',
    title: "The Bradford Pear Problem: Why Omaha's Most Popular Tree Is a Ticking Time Bomb",
    excerpt: "That beautiful white-flowering tree in your front yard has a structural defect baked into its DNA — and it usually fails catastrophically between ages 15 and 25.",
    date: '2025-04-10',
...
`,
  ...
  {
    slug: 'dont-top-your-trees-omaha',
    title: "Don't Top Your Trees: The $2,000 Mistake Omaha Homeowners Keep Making",
    excerpt: "Tree topping is still being sold by some companies in Omaha as a solution to large trees. It is not a solution — it is a slow death sentence that creates liability and costs homeowners significantly more in the long run.",
    date: '2025-06-20',
    category: 'Tree Care',
    content: `
...
`,
  ...
  {
    slug: 'ice-storm-season-omaha-tree-prep',
    title: 'Ice Storm Season in Omaha: How to Prepare Your Trees Before the Storm Hits',
    excerpt: "Omaha's 2019 ice storm caused tens of millions in property damage. The trees that failed weren't random — they were predictable. Here's how to identify and address yours before the next event.",
    date: '2025-09-05',
    category: 'Storm Prep',
    content: `
