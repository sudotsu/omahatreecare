...
import { getServiceSEO, getNeighborhoodSEO } from './src/seo/index'
...
// Test service page
const serviceExample = (servicesData as any)['tree-removal']
...
// Test location page
const neighborhoodExample = (neighborhoodData as any)['dundee']
