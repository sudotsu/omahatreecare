  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Get a FREE professional tree risk assessment in Omaha - same day or next day guaranteed. No-pressure evaluation from ISA certified arborist Andrew. Call or text anytime."
        />
        <link rel="canonical" href="https://omahatreecare.com/free-tree-assessment-omaha" />
        <meta
          property="og:title"
          content="FREE Same-Day Tree Assessment in Omaha - No Cost Quote"
        />
        <meta
          property="og:description"
          content="Expert tree risk assessment delivered within 24 hours. Zero cost, zero pressure. Text Andrew anytime."
        />
      </Head>
        ...
        <section className="bg-gradient-to-br from-primary-700 via-primary-600 to-primary-500 text-white pt-32 pb-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-5xl relative z-10">
            ...
            <p className="text-lg text-center text-primary-100 mb-10 max-w-2xl mx-auto">
              Zero cost. Zero pressure. Just honest advice from a local tree expert who lives in
              Omaha.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              ...
              >
                <span className="text-sm font-semibold mb-1">
                  Urgent? Call/Text Andrew, Anytime of the Day
                </span>
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-2xl">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-neutral-600">
                  Andrew will call you within 2 hours (or first thing tomorrow if after 7pm)
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-semibold text-neutral-900 mb-2"
                  >
                    Tell us about your tree concern
                  </label>
                  <textarea
                    id="message"
                    rows={4}
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                No catch. No hidden fees. Just a genuine safety check from someone who cares about
                neighbors and neighborhood trees.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8 hover:border-primary-500 transition-all">
                ...
                <h3 className="text-xl font-bold text-neutral-900 mb-3">
                  15-Minute On-Site Inspection
                </h3>
                <p className="text-neutral-600 mb-4">
                  Andrew walks your property, examines the tree in question, and checks for hidden
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8 hover:border-primary-500 transition-all">
                ...
                <p className="text-neutral-600 mb-4">
                  Get straight answers. If your tree is healthy, Andrew will tell you. If it&apos;s
                  dangerous, you&apos;ll know exactly why.
                </p>
                <ul className="space-y-2 text-sm text-neutral-700">
                  <li className="flex items-start gap-2">
                    <CheckCircle
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8 hover:border-primary-500 transition-all">
                ...
                <h3 className="text-xl font-bold text-neutral-900 mb-3">
                  Written Quote (If Needed)
                </h3>
                <p className="text-neutral-600 mb-4">
                  If work is recommended, you&apos;ll get a detailed quote before we leave. No
                  follow-up calls, no sales pitch.
                </p>
                <ul className="space-y-2 text-sm text-neutral-700">
                  <li className="flex items-start gap-2">
                    <CheckCircle
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-5xl">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-neutral-900 mb-4">
                Why Omaha Homeowners Trust This Assessment
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700">
                      Not &quot;free estimate then we pressure you.&quot; Andrew invests this time
                      to build neighborhood relationships. If your tree is healthy, he&apos;ll tell
                      you and leave. No strings attached.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-md">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700">
                      Not a salesperson. Not an estimator. Andrew is the ISA Certified Arborist who
                      will actually do the work. He lives in Omaha and has for years.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-md">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">
                      Same Day or Next Day, Guaranteed
                    </h3>
                    <p className="text-neutral-700">
                      Call before 5pm, Andrew can usually be there same day. Call later? First thing
                      next morning. We know tree worries keep you up at night.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-md">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">
                      Peace of Mind, Not a Sales Pitch
                    </h3>
                    <p className="text-neutral-700">
                      The goal is simple: give you the truth so you can sleep better. If removal is
                      needed, you&apos;ll know why. If not, you saved money and gained confidence.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-primary-500 pl-6 py-4">
                ...
                <p className="text-neutral-700">
                  It&apos;s genuinely free. Andrew invests 15 minutes per assessment to build
                  long-term relationships in Omaha neighborhoods. If your tree is healthy, you
                  won&apos;t hear from us again unless you reach out. If work is needed and you hire
                  us, great. If not, no hard feelings.
                </p>
              </div>
              ...
              <div className="border-l-4 border-primary-500 pl-6 py-4">
                ...
                <p className="text-neutral-700">
                  Same day if you call before 5pm (most days). Otherwise, first thing the next
                  morning. We know tree concerns are stressful—we prioritize speed.
                </p>
              </div>
              ...
              <div className="border-l-4 border-primary-500 pl-6 py-4">
                ...
                <p className="text-neutral-700">
                  Absolutely not. Andrew&apos;s reputation is built on honesty. If pruning is safer
                  than removal, he&apos;ll say so. If you can wait a few months, he&apos;ll tell
                  you. His goal is to provide accurate information, not to upsell.
                </p>
              </div>
            </div>
          </div>
