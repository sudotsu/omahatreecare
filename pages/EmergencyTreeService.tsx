...
import { makeServiceJsonLd } from "@/lib/jsonld";
          ...
          <Container>
            <Grid cols={1} mdCols={2} gap="xl">
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-black text-content-heading dark:text-content-inverse uppercase italic mb-6">
                    What We Prioritize
                  </h2>
                    ...
                    {[
                      {
                        ...
                        desc: "Trees fallen on roofs, siding, or breaking windows",
                        icon: ShieldAlert,
                      },
                      {
                        title: "Blocked Access",
                        desc: "Driveways, garage doors, or main entryways blocked by debris",
                        icon: AlertTriangle,
                      },
                      {
                        title: "Immediate Hazard",
                        desc: "Hanging limbs ('widowmakers') threatening safety or lines",
                        icon: Clock,
                      },
                    ].map((item, i) => (
                      <Card
                        key={i}
                        className="flex gap-4 p-4 bg-surface-warm/50 dark:bg-surface-dark/50 border-neutral-100 dark:border-neutral-800"
                      >
                        <item.icon className="w-6 h-6 text-brand-accent shrink-0" />
                        <div>
                          <h3 className="font-bold text-content-heading dark:text-content-inverse uppercase italic text-sm">
                            {item.title}
                          </h3>
                          <p className="text-content-body dark:text-content-muted text-sm">
                            {item.desc}.
                          </p>
                        </div>
                      </Card>
                ...
                <div className="p-6 bg-brand-accent/5 dark:bg-brand-accent/10 rounded-3xl border-2 border-brand-accent/20">
                  <h3 className="font-black uppercase italic text-brand-accent mb-2">
                    Response Protocol
                  </h3>
                  <p className="text-sm text-content-body dark:text-content-muted font-medium">
                    We triage calls based on severity. Structural damage and safety risks come
                    first. Emergency rates apply for after-hours and holiday service calls.
                  </p>
                </div>
              </div>
              ...
              <Card
                variant="feature"
                className="bg-content-heading text-content-inverse p-8 md:p-12 rounded-[3rem] shadow-2xl space-y-8 border-none"
              >
                <h2 className="text-3xl font-black uppercase italic leading-none">
                  Insurance Claims <br />
                  <span className="text-brand-primary text-xl">Assistance Included</span>
                </h2>
                <p className="text-content-inverse/70 font-medium">
                  Dealing with storm damage is stressful. We help streamline your homeowner&apos;s
                  insurance claim with professional documentation.
                </p>
                  ...
                  {[
                    {
                      ...
                      desc: "Removing the immediate threat to prevent further damage.",
                      icon: ShieldAlert,
                    },
                    {
                      step: "Step 2",
                      title: "Photo Documentation",
                      desc: "Comprehensive photos and itemized invoicing for adjusters.",
                      icon: Camera,
                    },
                    {
                      step: "Step 3",
                      title: "Full Clean-up",
                      desc: "Complete debris haul-away once the property is safe.",
                      icon: CheckCircle,
                    },
                  ].map((item, i) => (
                    <div key={i} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-content-inverse uppercase text-xs tracking-widest">
