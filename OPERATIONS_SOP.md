...
- Production store, delivery provider/account, destination inbox, alert destination, and escalation contact must be recorded in the private operations system; never put credentials here.
...
- Acceptance failure: preserve the fail-closed response and phone fallback; investigate storage availability and permissions.
